namespace FordonApp
{
    ...
    public class ParkingSpot
    {
        ...
        public void TaBortFordon(Vehicle vehicle)
        {
        ...
        public class ParkeringsHus
        {
            ...
            public void Parkera(Vehicle vehicle)
            {
            ...
            public void TaBortFordon(string registreringsNummer)
            {
                ...
                {
                    var fordon = plats.VehicleOnLot.Find(f => f.RegistrationNumber == registreringsNummer);
                    if (fordon != null)
                    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                parkeringsHus.Parkera(car1);
                parkeringsHus.Parkera(mc1);
                parkeringsHus.Parkera(bicycle1);
